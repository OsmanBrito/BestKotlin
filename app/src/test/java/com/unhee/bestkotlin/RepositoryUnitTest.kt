...
import com.unhee.bestkotlin.data.entity.Owner
...
class RepositoryUnitTest {
    ...
    fun writeUserAndReadInList() {
        ...
        repos.add(Repository(1, "repository name1", 789, 100, owner1))
        repos.add(Repository(2, "repository name2", 456, 200, owner1))
        repos.add(Repository(3, "repository name3", 123, 300, owner1))
